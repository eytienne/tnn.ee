			...
			{#snippet child({ props })}
				...
				style:--tw-shadow="4px 4px 6px -1px var(--tw-shadow-color, rgb(0 0 0 / 0.1)), 2px 2px 4px -2px var(--tw-shadow-color, rgb(0 0 0 / 0.1))"
					class={cn(
						...
						"data-[side=top]:translate-x-1/2 data-[side=top]:translate-y-[calc(-50%+3.25px)]",
						"data-[side=bottom]:-translate-x-1/2 data-[side=bottom]:-translate-y-[calc(-50%+2px)]",
						"data-[side=right]:translate-x-[calc(50%+1.5px)] data-[side=right]:translate-y-1/2",
						"data-[side=left]:translate-x-[0.5px] data-[side=left]:-translate-y-[calc(50%-3px)]",
						arrowClasses
					)}
					{...props}
				></div>
